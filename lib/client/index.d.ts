 ...
 * @return {function}
 */
export declare const LedgerSigningDelegate: (ledgerApp: any, preSignCb: (preSignCb: Buffer) => void, postSignCb: (pubKeyResp: any, sigResp: any) => void, errCb: (error: any) => void, hdPath: number[]) => typeof DefaultSigningDelegate;
/**
